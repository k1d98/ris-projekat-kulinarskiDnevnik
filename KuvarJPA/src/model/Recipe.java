...
public class Recipe implements Serializable {
	...
	@ManyToMany
	@JoinTable(name = "exist_in", joinColumns = { @JoinColumn(name = "Recipe_idRecipe") }, inverseJoinColumns = {
	...
	public List<Contain> getContains() {
		if(contains == null) contains = new ArrayList<Contain>();
	...
	public void addToFavCategory(Favourite_category fc) {
		if(favouriteCategories == null) favouriteCategories = new ArrayList<Favourite_category>();
		favouriteCategories.add(fc);
	}
