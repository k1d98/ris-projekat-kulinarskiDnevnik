		...
		<div class="content">
			<div class="contact-profile">
				...
				<div class="social-media">
					<a href="/Kuvar/controller/users/profile">Profile</a>
				</div>
			</div>
			<div class="messages">
				<ul>
					<c:if test="${!empty poruke }">
						<c:forEach items="${poruke }" var="p">
							<c:choose>
								<c:when test="${p.user1.idUser == user.idUser }">
									<li class="sent">
										<p>${p.content }</p>
									</li>
								</c:when>
								<c:otherwise>
									<li class="replies"><p>${p.content }</p></li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
					</c:if>
			...
			<div class="message-input">
				<div class="wrap">
					<form action="/Kuvar/controller/users/sent" method="post">
